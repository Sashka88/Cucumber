...
import static onliner.framework.baseElement.BaseElement.waitUntilIsInvisibilityOfElement;
...
public class TvPage extends BasePage {
  ...
  private Label makerResults = new Label(By.xpath("//span[contains(@data-bind, 'html: product.extended_name || product.full_name')]"));
  private Label priceResults = new Label(By.xpath("//a[contains(@data-bind, 'attr: {href: $data.prices.html_url_with_region}')]/span"));
  private Label descriptionResults = new Label(By.xpath("//span[contains(@data-bind, 'html: product.description')]"));
  ...
  public TvPage selectMaker(String tvMaker) {
    ...
    waitUntilIsInvisibilityOfElement(animation);
    return this;
  }
